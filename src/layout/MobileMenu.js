...
import mobile_banner from "../../public/assets/images/mobile_banner.png";
  ...
  return (
    <Fragment>
      <aside className={`aside_bar aside_bar_left aside_mobile ${showMobileMenu ? "open" : ""}`}>
        ...
        <Link href="/">
          <a className="logo">
            <Image src={mobile_banner} alt="logo" />
          </a>
        </Link>
        {/* logo */}
        {/* Menu */}
        <nav>
          <ul className="main-menu">
            ...
            <li className="menu-item">
              <a href={language == "en" ? "/contact" : "/contact-bg"}>{language == "en" ? "Contact Us" : "Контакти"}</a>
            </li>
