          ...
          <div className="col-lg-6">
            ...
            <div className="quote_sec about relative z-1">
              ...
              <p className="font-bold ...">
                ● Proprietary online platform which connects you with your employee throughout the whole day.<br></br>●
                Secure/ encrypted file sharing platform, enabling easy management and sharing of file structures and
              ...
              <p className="font-bold ...">
                ● We provide a localized phone number or toll-free phone number, allowing the employee to communicate
