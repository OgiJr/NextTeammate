        ...
        <div className="row justify-content-center">
          <div className="col-lg-4">
            <div className="section-title left-align wow fadeInDown">
              ...
              <p className="mb-0">
                Nextteammate е платформа, създадена с цел да улесни процеса на
                наемане на работа както за компанията, така и за служителите.
                Ние предлагаме работа за чуждестранни фирми и нова и цялостна
                система за дистанционна работа/ работа от дома (WFH) / (bpo),
                която е лесна, надеждна и сигурна и най-важното – ефективна.
              </p>
            </div>
