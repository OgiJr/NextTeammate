          ...
          <div className="col-12">
            <div className="section-title wow fadeInUp mv-rigj">
              ...
              <p className="text-bold text-lg">
                ...
                variety of fields to create more online collaboration
                opportunities.
              </p>
            </div>
          </div>
          <div className="flex flex-row justify-center flex-wrap gap-4">
            <div className="lg:!max-w-[25%] ">
              ...
              >
                ...
                <h5>Goal</h5>
                <p>
                  Our goal is to provide a motivated prospective team member to
                  an US Company and to enable the best possible interaction
                  between them, both during the approval process and throughout
                  their entire collaboration relationship.
                </p>
              </div>
            </div>
            <div className="lg:!max-w-[25%]">
              ...
              >
                ...
                <h5>Mission</h5>
                <p>
                  Our mission is to provide an easy and seamless communication
                  system, suitable and accessible for both parties.
                </p>
              </div>
            </div>
            <div className="lg:!max-w-[25%]">
              ...
              >
                ...
                <h5>Vision</h5>
                <p>
                  Our vision is to build a strong connection between the team
                  members and the US company which leads to high effectiveness
                  and at the same time helping both sides.
                </p>
              </div>
            </div>
          </div>
