          ...
          <div className="flex flex-row justify-center flex-wrap gap-4">
            <div className="lg:!max-w-[25%] ">
              ...
              >
                ...
                <h5>Goal</h5>
                <p>
                  Our goal is to connect job seekers with employers and to
                  enable the best possible interaction between them, both during
                  the hiring process and throughout their entire working
                  relationship.
                </p>
              </div>
            </div>
            ...
            <div className="lg:!max-w-[25%]">
              ...
              >
                ...
                <h5>Vision</h5>
                <p>
                  Our vision is to build international connections between
                  employers and employees which lead to high effectiveness.
                </p>
              </div>
            </div>
          </div>
