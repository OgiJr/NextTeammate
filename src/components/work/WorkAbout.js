        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-5 col-lg-6">
            <div className="section-title left-align wow fadeInUp">
              ...
              <p>
                Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatue
                velillum{" "}
              </p>
            </div>
            <ul className="about_list">
              <li className=" wow fadeInDown">
                ...
                <div className="text">
                  ...
                  <p className="mb-0">Quis autem vel eum iure reprehenderit quein ea voluptate velit esse quam</p>
                </div>
              </li>
              <li className=" wow fadeInDown">
                <div className="icon">
