              ...
              <div className="text_box">
                ...
                >
                  <NextSeo
                    ...
                    description="Start working for American based conmpany from the comfort of your home"
                    nexttemamate="https://nextteammate.com"
                    openGraph={{
                      url: "https://nextteammate.com/i-want-to-work",
                      title:
                        "Work for major U.S. based companies from the comfort of your own home!",
                      description:
                        "Start working for American based conmpany from the comfort of your homey",
                      images: [
                        {
