    ...
    <Layout>
      ...
      <div className="section-padding faqs_elements">
        <div className="container relative z-1">
          ...
          <img src="assets/images/elements/circle3.png" alt="element" className="element_1 zoom-fade" />
          ...
          <img src="assets/images/elements/circle3.png" alt="element" className="element_5 rotate_elem" />
        </div>
      </div>
      {/* Faqs End */}
    </Layout>
