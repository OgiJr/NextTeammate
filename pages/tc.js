...
const Faq = () => {
  ...
  gtag('config', 'AW-11157459203');`}
        ...
        <link rel="canonical" href="https://www.nextteammate.com/tc" />
        <link rel="shortlink" href="https://nextteammate.com/tc" />
        ...
        <link
          rel="alternate"
          hrefLang="en"
          href="https://www.nextteammate.com/tc"
        />
        <link rel="shortlink" href="https://nextteammate.com/tc" />
        <link rel="shortcut icon" href="icon.jpg" />
        ...
        <meta
          name="description"
          content="The words of which the initial letteris capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural."
        />

        <meta
          name="keywords"
          content="Employee retention,HR consulting, HR solutions, Performance management, HR software, HR technology, Benefits administration, Compliance management, Payroll processing,"
        />
        ...
        <meta name="classification" content="Terms and Conditions" />
        ...
        <meta name="page-topic" content="Terms and Conditions" />
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            The words of which the initial letteris capitalized
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            <br></br>• &quot;Terms and Conditions·(also referred
                            as &#39;Terms&quot;) mean these Terms and Conditions
                            that form the entire agreement between You and the
                            Company regarding the use of the Service.<br></br>•
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            responsible for safeguarding the password that You
                            use to access the Service and for any activities or
                            actions under Your password,whether Your password is
                            with Our Service or a Third-Party Social Media
                            Service. You agree not to disclose Your password to
                            any third party. You must notify Us immediately upon
                            becoming aware of any breach of security or
                            unauthorized use of Your account. You may not use as
                            a username the name of another person or entity or
                            that is not lawfully available for use,a name or
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            appropriateness. By posting Content to the
                            Service,You grant Us the right and license to use,
                            modify,publicly perform, publicly
                            ...
                            also use Your Content subject to these Terms. You
                            represent and warrant that: (i) the Content is Yours
                            (You own it) or You have the right to use it and
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            the Service&#39;s users. You expressly understand
                            and agree that You are solely responsible for the
                            Content and for all activity that occurs under your
                            account, whether done so by You or any third person
                            using Your account. You may not transmit any Content
                            that is unlawful, offensive, upsetting, intended to
                            disgust,threatening, libelous, defamatory, obscene
                            or otherwise objectionable. Examples of such
                            objectionable Content include, but are not limited
                            to,the following:
                            <br></br>
                            <br></br>• Unlawful or promoting unlawful activity.
                            <br></br>• Defamatory,discriminatory, or
                            mean-spirited content, including references or
                            commentary about religion, race, sexualorientation,
                            gender, national/ethnic origin,or other targeted
                            groups.<br></br>• Spam, machine - or randomly -
                            ...
                            gambling.
                            <br></br>• Containing or installing any
                            ...
                            other information of a third person.<br></br>•
                            ...
                            rights.<br></br>• Impersonating any person or entity
                            including the Company and its employees or
                            representatives.<br></br>• Violating the privacy of
                            any third person.<br></br>• False information and
                            features .<br></br>
                            <br></br>The Company reserves the right, but not the
                            obligation,to, in its sole discretion, determine
                            whether or not any Content is appropriate and
                            complies with Terms,refuse or remove this Content.
                            The Company further reserves the right to make
                            ...
                            Content. As the Company cannot control all content
                            posted by users and/or third parties on the
                            Service,you agree to use the Service at your own
                            risk. You understand that by using the Service You
                            may be exposed to content that You may find
                            offensive,indecent, incorrect or obje ctionable, and
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            the Company does not guarantee there will be no loss
                            or corruption of data. Corrupt or invalid backup
                            points may be caused by, wit houtlimitation,Content
                            that is corrupted prior to being backed up or that
                            changes during the time a backup is performed. The
                            ...
                            restore Content to a usable state . You agree to
                            maintain a complete and accurate copy of any Content
                  ...
                  <Tab.Pane className="tab-pane fade" eventKey="allcoach">
                    ...
                    >
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            Content posted on the Service infringes a copyright
                            or other intellectual property infringement of any
                            person. If You are a copyright owner, or authorized
                            ...
                            place through the Service, You must submit Your not
                            ce in writing to the attention of our copyright
                            agent via email ([COPYRIGHT_AGENT_CONTACT_EMAIL])
                            and includein You r notice a detailed description of
                            the alleged infringement. You may be held
                            accountable for damages (including costs and
                            attorneys&#39; fees) for misrepresenting that any
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            You may submit a notificat ion pursuant to the
                            ...
                            detail):<br></br>
                            <br></br>• An electronic or physical signature of
                            the person authorized to act on behalf of the owner
                            of the copyright&#39;s interest.
                            <br></br>• A description of the copyrighted work
                            that You claim has been infringed,including the URL
                            (i.e., web page address) of the location where the
                            copyrighted work exists or a copy of the copyrighted
                            work .<br></br>• Identification of the URL or other
                            specificlocation on the Service where the material
                            that You claim is infringing is located.<br></br>•
                            Your address , telephone number, and email address.
                            <br></br>• A statement by You that You have a good
                            faith belief that the disputed use is not authorized
                            by the copyright owner,its agent, or the law.
                            <br></br>• A statement by You,made under penalty of
                            perj ury, that the above information in Your notice
                            is accurate and that You are the copyright owner or
                            authorized to act on the copyright owner&#39;s
                            behalf.<br></br>
                            <br></br>You can contact our copyright agent via
                            email ([COPYR IGHT_AGENT_CONTACT_EMAIL]). Upon
                            receipt of a notification,the Company will take
                            whateve r action, in its sole discretion,it deems
                            appropriate, including removal of the challenged
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            and functionality are and wi ll remain the exclusive
                            property of the Company and its licensors. The
                            Service is protected by copyright,trademark, and
                            other laws of both the Country and foreign
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            WYou assign all rights, title and interest in any
                            ...
                            royalty free, worldwide right and license to use,
                            reproduce,disclose,sub-license, distribute, modify
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            connection with the use of or relance on any such
                            content, goods or services available on or through
                            any such web sites or services. We strongly advise
                            You to read the ter ms and conditions and privacy
                            policies of any third-party web sites or services
                            that You visit.
                          </div>
                        </Accordion.Collapse>
                      </div>
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            immediately,wit hout prior notice or liability, for
                            ...
                            immediately. If You wish to terminate Your Account,
                      ...
                      <div className="card">
                        ...
                        >
                          <div className="card-body">
                            ...
                            entire liability of the Company and any of its
                            ...
                            the Service or 100 USO if You haven&#39;t purchased
                            anything through the Service. To the maximum extent
                            permitted by appl cablelaw,in no event shall the
                            Company orits suppliers be liable for any special,
                            incidental,indirect, or consequential damages
                            whatsoever including,but not limited to, damages for
                            loss of profits, loss of data or other information,
                            for business interruption,for personalinjury, loss
